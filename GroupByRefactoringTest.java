...
public class GroupByRefactoringTest {
    ...
    // @Test
    // public void checkQueryWithNotValidParameterWithoutGroupBy_ThenGroupByNotNeeded() throws RefactoringException {
    //     String result;
    //     Refactoring refactoring = new GroupByRefactoring();
    //     String queryToTransform = "SeleCT P.name,P.edad FROM PERSONA P;";
    ...
    public void checkQueryWithOrderByWithoutGroupBy_ThenGroupByAdded() throws RefactoringException {
        String result;
        Refactoring refactoring = new GroupByRefactoring();
        String queryToTransform = "SeleCT P.name,P.edad FROM PERSONA P ORDER BY P.name;";
        ((GroupByRefactoring) refactoring).setStmtParameter("P.name");

        result = refactoring.refactor(queryToTransform);

        assertEquals("SeleCT P.name,P.edad FROM PERSONA P GROUP BY P.name ORDER BY P.name;", result);
    }
    ...
    // @Test
    // public void checkQueryWithGroupBy_ThenTransformNotNeeded() throws RefactoringException {
    //     String result;
    ...
    // @Test
    // public void checkQueryWithBadParameterWithoutGroupBy_ThenTransformNotNeeded() throws RefactoringException {
    //     String result;
    ...
    // @Test
    // public void checkQueryWithHavingAndGroupBy_ThenTransformNotNeeded() throws RefactoringException {
    //     String result;
    ...
    // @Test
    // public void checkQueryWithHavingAndWithoutGroupBy_ThenTransformNotNeeded() throws RefactoringException {
    //     String result;
    ...
    //         result = refactoring.refactor(queryToTransform);
    //     } catch (Exception e) {
    //         System.out.println("Error de la exception: ");
